      ...
      <div class="lot-item__content">
        ...
        <div class="lot-item__right">
          <div class="lot-item__state">
            ...
            <?php
              if ($date[0] < 1) : ?>timer--finishing<?php endif ?>"> <!-- Добавляем класс в зависимость от возвращаемого знаячения -->
                <?php
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                <span class="lot-item__amount">Текущая цена</span>
                      <?php 
                        if ($val['rate_sum'] != NULL) : ?>  <!-- Если ставки есть, то вернет максимальную, если нет, то стартовую цену -->
            ...
            в задании про _POST тоже ничего нет, да и дальше по учебнику также нет про это поле, может они забыли-->
          </div>
