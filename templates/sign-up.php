...
<?= $header; ?>
  ...
  <main>
    ...
    <?php if (isset($errors)):?>form--invalid<?php endif;?>" action="signUpScenario.php" method="post" autocomplete="off" enctype="application/x-www-form-urlencoded"> <!-- form
    --invalid -->
      ...
      <?php if (isset($errors['email'])):?>form__item--invalid<?php endif?>">
        ...
        <span class="form__error"><?php if(is_string($errors['email']) ) { //Если в массиве булево 1 или 0 то возвражает определенную строку, если ошибка задана в сценарии, то возвращает её
