	...
	<div class="page-wrapper">
		...
		<main>
			...
			<form class="form container
    			<?=isset($errors) ? 'form--invalid': ''?>" action="signUpScenario.php" method="post" autocomplete="off" enctype="application/x-www-form-urlencoded">
				...
				<div class="form__item
					...
					<span class="form__error">
						<?= isset($errors['email']) && is_string($errors['email']) ? $errors['email'] : 'Введите Email' ?>
					</span>
				</div>
				<div class="form__item
				...
				<?=isset($errors['name']) ? 'form__item--invalid' : ''?>">
					...
					<input id="name" type="text" name="name" placeholder="Введите имя" value=<?= htmlspecialchars($user_name ?? ''); ?>>
