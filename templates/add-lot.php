        ...
        <?php if (isset($errors['category_id'])) : ?>form__item--invalid<?php endif ?>">
				...
				<div class="form__item form__item--file">
					...
					<?php if (isset($errors['image'])) : ?>form__item--invalid<?php endif ?>">
						...
						<label for="lot-img">
							<?php if (isset($path)){  //Если файл загружен, то отобразит его имя на устройстве user_name
								print $path;		  // Но при длинном наименовании фала выходит за пределы верстки
							}else{
							print 'Добавить';
							}?>
						</label>
